...
export const Work = () => {
 ...
 The Web version is built with Vanilla JavaScript, it gives you a summary of the best times for the whole week, has a responsive design, and follows accessibility and responsiveness best practices.
